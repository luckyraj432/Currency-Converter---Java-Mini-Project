...
## Credits
This project was created by Lucky raj ,Dr .Aith College as a Java mini project. The project uses the Exchange Rate API to retrieve live exchange rate data. Special thanks to the creators of the Exchange Rate API for providing a free and reliable service.
